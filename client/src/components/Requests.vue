    ...
    <div class="row pb-xl">
      <div class="col">
        <div class="text-regular-20 pb-m">
          Well done! Your link was successfully created.
        </div>
        <div class="divider" />
      </div>
    </div>
            ...
            <div class="row py-m flex-between">
              <div class="two-list-item-action__left-item col request-title">
                ...
                <div class="request-content">
                  ...
                  <div class="row">
                    <div class="text-regular-14">
                      Retrieve the transactions from the last 30 days from each one of the accounts inside the link
                      already created.
                    </div>
                  </div>
                </div>
              ...
              <div class="row py-m flex-between">
                ...
                <div class="request-content">
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="text-regular-14">
                        Restart the application, if the user wants to create a new link.
                      </div>
                    </div>
                  </div>
                </div>
                <div class="list-item-action col">
                  <b-button type="primary" :fluid="false" text="Send request" @clicked="restartBelvoWidget()" />
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    restartBelvoWidget() {
      axios.delete('http://127.0.0.1:5000/links/' + this.linkId);
